...
namespace Ceive\Data\OuterValueAccessor {
	...
	/**
	 * Class ValueAccessor
	 * @package Ceive\Data\OuterValueAccessor
	 */
	class ValueAccessor{
		...
		/**
		 * @return ValueAccessSetterInterface
		 */
		public static function getDefaultSetter(){
			static $setter;
			if(!$setter){
				$setter = new ValueAccessSetter();
			}
			return $setter;
		}

		/**
		 * @return ValueAccessGetterInterface
		 */
		public static function getDefaultGetter(){
			static $getter;
			if(!$getter){
				$getter = new ValueAccessGetter();
			}
			return $getter;
		}
		...
		public static function checkoutGetter($getter){
			...
			if($getter instanceof ValueAccessGetterInterface || $getter instanceof \Closure || $array){
				if($array){
					/** @var array $getter */
		...
		public static function checkoutSetter($setter){
			...
			if($setter instanceof ValueAccessSetterInterface || $setter instanceof \Closure || $array){
				if($array){
					/** @var array $setter */
		 ...
		 * @param \Ceive\Util\PropertyRegistry\PropertyRegistryInterface|mixed $data
		 * @param string $key
		 * @return mixed
		 */
		 ...
		 * @param string $key
		 * @param mixed $value
		 * @return \Ceive\Util\PropertyRegistry\PropertyRegistryInterface|mixed
		 */
